    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{
            background:
              "radial-gradient(70% 60% at 20% 0%, rgba(246,91,180,.28), transparent 60%), radial-gradient(60% 50% at 100% 10%, rgba(245,61,130,.24), transparent 60%), linear-gradient(180deg,#2b0e26 0%,#1a0a15 60%)",
          }}
        >
